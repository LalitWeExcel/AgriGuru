function SaveEPujaOrder(IsAddToCart) {

    var isValid = true;
    var PujaTime = $("#AddTimeSlot option:selected").val()
    var epujaemail = $("#txtepujaemail").val();
    var EPujaPhoneNo = $("#txtEPujaPhoneNo").val();
    ...
    if (PujaTime == "0" || PujaTime == "") {
        ...
        $('#spnepujaemail').html('Please Enter E-Puja mail!');
        $('#spnepujaemail').removeClass('hide');
        $('#spnAddTimeSlot').addClass('hide');
        isValid = false;
    } else if (!ValidateEmail(epujaemail)) {
        $('#spnepujaemail').html('Please Enter a vaild E-puja Email!');
        $('#spnepujaemail').removeClass('hide');
        $('#spnAddTimeSlot').addClass('hide');
        isValid = false;
    } else if (EPujaPhoneNo == "") {
        $('#spnEPujaPhoneNo').html('Please Enter E-Puja Number!');
        $('#spnEPujaPhoneNo').removeClass('hide');
        $('#spnepujaemail').addClass('hide');
        isValid = false;
    } else if (EPujaPhoneNo.length < 10) {
        $('#spnEPujaPhoneNo').html('E-Puja Number should be 10 digit!!');
        $('#spnEPujaPhoneNo').removeClass('hide');
        $('#spnepujaemail').addClass('hide');
        isValid = false;
    }
    ...
    if (!isValid) {
        ...
        var JsonData = {
            "PujasList": [{
                ...
                "epujaemail": epujaemail,
                "EPujaPhoneNo": EPujaPhoneNo,
            }],
            "CustomerDetail": {
