...
@Component({
  selector: 'app-audit-officer-audit-list',
  templateUrl: './audit-officer-audit-list.component.html',
  styleUrls: ['./audit-officer-audit-list.component.scss']
})

export class AuditOfficerAuditListComponent implements OnInit {
