...
@Component({
  selector: 'app-chief-auditor',
  templateUrl: './chief-auditor.component.html',
  styleUrls: ['./chief-auditor.component.scss']
})
export class ChiefAuditorComponent implements OnInit {
  ...
  public chief_audit_Officer_Id: number = 0;
  public audit_Officer_Id: number = 0;
  public auditorOrderDate: string = '';
  ...
  ngOnInit() {
    ...
    this.chief_audit_Officer_Id = Number(localStorage.getItem("userID"));
    this.GetChiefAuditOfficerRequestData();
  }

  public GetChiefAuditOfficerRequestData() {
    const params = this.RequestParams(
      this.pagenumber,
      this.pageSize,
      this.chief_audit_Officer_Id,
      this.audit_Officer_Id,
      this.auditStatus_Id,
      this.auditorOrderDate,
    );
    this.loading = true;
    this._AuditService.GetChiefAuditOfficerRequestData(params).subscribe({
      next: (response: any) => {
  ...
  public RequestParams(
    ...
    if (chief_audit_Officer_Id) {
      params[`chief_audit_Officer_Id`] = chief_audit_Officer_Id;
    }
    if (audit_Officer_Id) {
    ...
    if (auditorOrderDate) {
      params[`auditorOrderDate`] = auditorOrderDate;
    }
  ...
  public CallBackModal(request: view_GetAuditRequest): any {
    ...
    this.chief_audit_Officer_Id = request.chief_audit_Officer_Id;
  ...
  public SendBackAuditOrder(): void {
    ...
    if (this.auditRemarks == "") {
      ...
      this.model.chief_audit_Officer_Id = Number(this.chief_audit_Officer_Id);
  ...
  public GetAuditAuditorDropDownByOfficer() {
    let params: any = {};
    params[`chief_audit_Officer_Id`] = this.chief_audit_Officer_Id,
