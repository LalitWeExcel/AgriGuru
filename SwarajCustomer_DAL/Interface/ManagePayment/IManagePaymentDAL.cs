...
{
    public interface IManagePaymentDAL
    {
        IList<M_ManagePayment> GetManagePaymentList(int page, int pageSize, string fromdate, string todate, string status, string mode, string search, out int recordsCount, out int totelSuccessPayment, out int totelFailedPayment, out decimal totelRevenue,
